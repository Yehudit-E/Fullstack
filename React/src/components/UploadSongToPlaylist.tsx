  ...
  return (
    <div className="upload-music-container">
      <div className="upload-music-header">
        <h1 className="upload-music-title">Upload to Playlist</h1>
        ...
        {step === 1 && (
          <div className="upload-step-content">
            ...
            <div className="upload-actions">
              <button className="upload-button secondary" onClick={() => navigate(`/playlist/${playlistId}`)}>
                <ChevronLeft size={16} />
        ...
        {step === 3 && (
          <div className="upload-step-content success-step">
            ...
            <div className="upload-actions">
              ...
              <button className="upload-button primary" onClick={() => navigate(`/myplaylists/playlist/${playlistId}`)}>
