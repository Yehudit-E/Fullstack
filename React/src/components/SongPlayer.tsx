...
const SongPlayer = () => {
    ...
    const addPlay = (id: number) => {
        SongService.addPlaySong(id)
        console.log("addPlaySong");
                ...
                <Box sx={{
                    ...
                    <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", p: -10 }}>
                        ...
                        <Box
                            ...
                            onClick={() => { if (songsList[currentSongIndex].isPublic) navigator(`/song/${btoa(songsList[currentSongIndex].id.toString() + "-song")}`) }} // כאן תוכל להוסיף ניווט
                        >
