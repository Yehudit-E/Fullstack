...
import type { RequestPostModel } from "../models/Request"
            ...
            <div className="form-grid">
              ...
              <div className="form-group checkbox-group">
                <label className="checkbox-container">
                  ...
                  <span className="checkbox-label">Make this song public</span>
                </label>
                <p className="checkbox-help">When enabled, other users can see and play this song once approved</p>
              </div>
            </div>
