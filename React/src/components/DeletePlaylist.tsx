...
interface DeletePlaylistProps {
  ...
  closeOnDeleteDialog: () => void
  closeOnCancleDialog: () => void
}

const DeletePlaylist = ({ playlistId, setPlaylists, closeOnDeleteDialog,closeOnCancleDialog }: DeletePlaylistProps) => {
  ...
  return (
    ...
    >
      <DialogTitle className="modal-header">
        ...
        <IconButton onClick={handleCancle} className="close-button" style={{ position: "absolute", left: "8px" }}>
          <Close />
        </IconButton>
      </DialogTitle>
